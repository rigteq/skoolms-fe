...
export default function StudentsPage() {
  ...
  useEffect(() => {
    const filtered = students.filter((student) => {
      ...
      const matchesClass =
        selectedClass === "" || student.class_name.includes(selectedClass);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1 font-medium">
            Manage student records, parent information, and academic levels.
          </p>
        </div>
        <button
            ...
            <tbody className="divide-y divide-slate-50">
              {paginatedStudents.map((student) => (
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-slate-400 font-bold mt-0.5 tracking-tight uppercase">
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2.5 py-1 bg-[#3b71ca]/10 text-[#3b71ca] rounded-md text-[10px] font-extrabold border border-[#3b71ca]/20 tracking-widest uppercase">
                      {student.class_name}
                    </span>
                  </td>
                  <td className="px-6 py-4">

    ...
    <div className="p-8 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1 font-medium">
            Configure academic years and manage classroom teacher assignments.
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col">
              ...
              {loading ? (
                ...
                filteredClasses.map((cls) => (
                  ...
                  >
                    ...
                    {/* School Name*/}
                    <td className="px-6 py-4">{cls.class_name || "N/A"}</td>

                    {/* Class */}
                    <td className="px-6 py-4">{cls.school_name || "N/A"}</td>
                ...
                <tr>
                  <td colSpan={6} className="px-8 py-32 text-center">
                    ...
                    <p className="text-slate-400 text-sm italic">
                      Try adjusting your search filters or add a new class.
                    </p>
                  </td>
                </tr>
              )}
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/10 flex items-center justify-between text-xs text-slate-500 font-bold px-8">
          <span>
            Showing {filteredClasses.length} of {classes.length} records
          </span>
          <div className="flex gap-2">
            <button
                ...
                <div className="space-y-1.5 md:col-span-2">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full px-5 py-3.5 bg-slate-50 border rounded-2xl text-xs font-bold text-slate-700 appearance-none focus:ring-4 outline-none transition-all ${
                        errors.school_id

              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-1.5 md:col-span-2">
                  ...
                  <input
                    ...
                    className={`w-full px-5 py-3.5 bg-slate-50 border rounded-2xl text-xs font-bold text-slate-700 focus:ring-4 outline-none ${
                      errors.school_name
        ...
        <div className="fixed bottom-8 right-8 z-[60] bg-slate-900 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 animate-in slide-in-from-right duration-500">
          ...
          <div className="pr-4">
            ...
            <p className="text-slate-400 text-xs">
              New school has been added to the registry.
            </p>
          </div>
          <button

      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1 font-medium italic">
            Monitor student enrollments, academic progress, and personal records
            across all schools.
          </p>
        </div>
        <button
              ...
              {loading ? (
                ...
                filteredStudents.map((student) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">{student.full_name || "N/A"}</td>
                    ...
                    <td className="px-6 py-4">{student.class_name || "N/A"}</td>
                ...
                <tr>
                  <td colSpan={10} className="px-8 py-32 text-center">
                    ...
                    <p className="text-slate-400 text-sm italic">
                      Try adjusting your search filters or add a new student.
                    </p>
                  </td>
                </tr>
              )}
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    <h4 className="text-[10px] font-black text-[#4CAF50] uppercase tracking-widest flex items-center gap-2">
                      <div className="w-6 h-[1px] bg-[#4CAF50]"></div> Academic
                      Link
                    </h4>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[11px] font-black text-slate-700 ml-1 uppercase">
                          School
                        </label>
                  ...
                  <div className="space-y-3">
                    <h4 className="text-[10px] font-black text-[#4CAF50] uppercase tracking-widest flex items-center gap-2">
                      <div className="w-6 h-[1px] bg-[#4CAF50]"></div> Student
                      Identity
                    </h4>
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-black text-slate-700 ml-1 uppercase">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-slate-50 border rounded-xl text-xs font-bold text-slate-700 focus:ring-4 outline-none transition-all ${
                          errors.full_name
                      ...
                      />
                      {errors.full_name && (
                        <p className="text-[9px] text-rose-500 font-black uppercase tracking-wider ml-1">
                          {errors.full_name}
                        </p>
                      )}
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <h4 className="text-[10px] font-black text-[#4CAF50] uppercase tracking-widest flex items-center gap-2">
                      <div className="w-6 h-[1px] bg-[#4CAF50]"></div> Guardian
                      Information
                    </h4>
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-black text-slate-700 ml-1 uppercase">
        ...
        <div className="fixed bottom-10 right-10 z-[60] bg-slate-900 border border-slate-800 text-white px-8 py-5 rounded-[1.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] flex items-center gap-5 animate-in slide-in-from-right duration-500">
          ...
          <div className="pr-6 border-r border-slate-800">
            ...
            <p className="text-slate-400 text-[10px] font-bold mt-1 uppercase tracking-widest">
              Student profile has been initialized
            </p>
          </div>
          <button
